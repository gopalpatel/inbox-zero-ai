 ...
 */
const YOUR_DECISION_COL_INDEX = AUDIT_HEADER_ROW.indexOf("Your decision");
...
/**
 * Formats a ratio (0–1) as an integer percentage string, e.g. 0.85 → "85%".
 */
    ...
    // Data validation for "Your decision" column (dropdown)
    {
      setDataValidation: {
        ...
        rule: {
          condition: {
            type: "ONE_OF_LIST",
            values: [{ userEnteredValue: "keep" }, { userEnteredValue: "filter" }, { userEnteredValue: "unsubscribe" }],
          },
          showCustomUi: true,
          strict: false,
        },
